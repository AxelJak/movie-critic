...
export type CastMembersResponse<Texpand = unknown> = Required<CastMembersRecord> & BaseSystemFields<Texpand>
export type MoviesResponse<Tgenres = unknown, Texpand = unknown> = Required<MoviesRecord<Tgenres>> & BaseSystemFields<Texpand>
export type ReviewsResponse<Texpand = unknown> = Required<ReviewsRecord> & BaseSystemFields<Texpand>
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> & AuthSystemFields<Texpand>
export type WatchlistMoviesResponse<Texpand = unknown> = Required<WatchlistMoviesRecord> & BaseSystemFields<Texpand>
export type WatchlistsResponse<Texpand = unknown> = Required<WatchlistsRecord> & BaseSystemFields<Texpand>
...
export type TypedPocketBase = PocketBase & {
	...
	collection(idOrName: 'watchlist_movies'): RecordService<WatchlistMoviesResponse>
